...
export const SITUATIONS = [
...

  {
    ...
    positions: {
      ...
      '3B':hold('3B', 'Stay near 3B'),
      LF:  go('lf-back-cf', 'Back up CF from the left side', true),
      CF:  hold('CF', 'Catch the ball; throw to SS relay toward 2B'),
      RF:  go('rf-back-cf', 'Back up CF from the right side', true),
    },
  },
...

  {
    ...
    positions: {
      ...
      '3B':go('cover-3b', 'Cover 3B; receive throw', false),
      LF:  go('lf-back-cf', 'Back up CF from the left', true),
      CF:  hold('CF', 'Catch; throw to SS relay toward 3B'),
      RF:  go('rf-back-cf', 'Back up CF from the right', true),
    },
  },
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    positions: {
      P:   go('p-backup-1b', 'Sprint behind 1B to back up in case of overthrow', true),
      ...
      '2B':go('cover-2b', 'Cover 2B in case runner retreats or advances', true),
