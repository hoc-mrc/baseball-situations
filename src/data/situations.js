...
export const SITUATIONS = [
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    ballDescription: 'Deep fly ball to left-center gap — caught by LF, no runners on base',
    positions: {
      ...
      CF:  go('cf-back-lf', 'Back up LF', true, null, 'CF is closest — sprint behind in the ball\'s direction to cut off any misplay before it reaches the wall.'),
...

  {
    ...
    ballDescription: 'Deep fly ball to left-center — caught by CF, no runners on base',
    positions: {
...

  {
    ...
    ballDescription: 'Deep fly ball to right-center gap — caught by RF, no runners on base',
    positions: {
      P:   go('p-backup-2b', 'Back up between mound and 2B', true, null, 'Position behind 2B on the relay throw line — backup if the throw sails past the bag.'),
      C:   hold('C', 'Stay near home'),
      '1B':hold('1B', 'Cover 1B'),
      ...
      CF:  go('cf-back-rf', 'Back up RF', true, null, 'CF is closest — sprint behind in the ball\'s direction to cut off any misplay before it reaches the wall.'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    ballDescription: 'Deep fly ball down the left field line — caught by LF, runner on 1B',
    positions: {
      P:   go('p-backup-3b', 'Sprint to back up 3B', true, null, 'Trail behind 3B on the throw line — backs up any errant throw from the outfield.'),
...

  {
    ...
    ballDescription: 'Deep fly ball to right-center — caught by CF, runner on 1B',
    positions: {
      P:   go('p-backup-3b', 'Back up 3B', true, null, 'Trail behind 3B on the throw line — backs up any errant throw from the outfield.'),
      C:   hold('C', 'Stay at home plate'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('cover-2b', 'Cover 2B', false),
      SS:  go('relay-cf-to-3b', 'Move into relay between CF and 3B', true, null, 'Runner heading to 3B — relay player gets halfway between outfielder and 3B on the throw line.'),
      '3B':go('cover-3b', 'Cover 3B; receive throw', false),
...

  {
    ...
    ballDescription: 'Deep fly ball down the right field line — caught by RF, runner on 1B',
    positions: {
      P:   go('p-backup-3b', 'Back up 3B', true, null, 'Trail behind 3B on the throw line — backs up any errant throw from the outfield.'),
      C:   hold('C', 'Stay at home plate'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('relay-rf-to-3b', 'Move out as relay toward RF/3B', true, null, 'Runner heading to 3B — relay player gets halfway between outfielder and 3B on the throw line.'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    playType: 'fly_ball',
    ballDestination: 'lf-line',
    ballDescription: 'Deep fly ball down the left field line — caught by LF, runners on 1B and 2B',
    positions: {
...

  {
    ...
    playType: 'fly_ball',
    ballDestination: 'cf-right',
    ballDescription: 'Deep fly ball to right-center — caught by CF, runners on 1B and 2B',
    positions: {
      P:   go('p-backup-home', 'Back up home plate', true, null, 'Sprint behind home plate in line with the throw — stops any overthrow from letting the runner advance.'),
      C:   go('cover-home', 'Set up at home', false),
      '1B':hold('1B', 'Cover 1B'),
...

  {
    ...
    playType: 'fly_ball',
    ballDestination: 'rf-line',
    ballDescription: 'Deep fly ball down the right field line — caught by RF, runners on 1B and 2B',
    positions: {
      P:   go('p-backup-home', 'Back up home plate', true, null, 'Sprint behind home plate in line with the throw — stops any overthrow from letting the runner advance.'),
      C:   go('cover-home', 'Set up at home', false),
      '1B':hold('1B', 'Cover 1B'),
...

  {
    ...
    positions: {
      ...
      SS:  go('relay-cf-to-2b', 'Field ball and throw to 2B; OR cover 2B', true, 'dpCoverage2B', 'Must be at the bag ready to receive the throw and apply the tag.'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    positions: {
      P:   go('p-cut-first-third', 'Per team system: serve as cut-off OR be ready at home', true, 'firstThirdDefense', 'Sprint behind home plate in line with the throw — stops any overthrow from letting the runner advance.'),
      C:   hold('C', 'Execute throw per team\'s first-and-third system'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('cover-2b', 'Cover 2B; receive throw', true, null, 'Must be at the bag ready to receive the throw and apply the tag.'),
      SS:  go('cover-3b', 'Watch runner on 3B; communicate', true, null, 'Must be at the bag ready to receive the throw and apply the tag.'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    positions: {
      P:   go('p-cover-home', 'Sprint immediately to cover home plate; receive throw', true, null, 'C is chasing the ball — pitcher must sprint to home plate to receive the throw and tag the runner.'),
      C:   hold('C', 'Chase the ball; throw to P at home'),
      '1B':hold('1B', 'Cover home as secondary if P can\'t get there'),
      '2B':go('cover-2b', 'Cover 2B', false),
      SS:  go('cover-3b', 'Cover 3B', true, null, 'Must be at the bag ready to receive the throw and apply the tag.'),
      '3B':go('cover-3b', 'Cover 3B', false),
...

  {
    ...
    positions: {
      ...
      '1B':hold('1B', 'Cover 1B; receive throw'),
      '2B':hold('2B', 'Cover 2B'),
      SS:  go('cover-3b', 'Back up or cover 3B', true, null, 'Must be at the bag ready to receive the throw and apply the tag.'),
...

  {
    ...
    playType: 'fly_ball',
    ballDestination: 'cf-right',
    ballDescription: 'Medium fly ball to right-center — caught by CF, runners on 1B and 3B tagging up',
    positions: {
      P:   go('p-backup-home', 'Back up home plate', true, null, 'Sprint behind home plate in line with the throw — stops any overthrow from letting the runner advance.'),
      C:   go('cover-home', 'Set up at home', false),
      '1B':hold('1B', 'Cover 1B'),
...

  {
    ...
    playType: 'fly_ball',
    ballDestination: 'cf-right',
    ballDescription: 'Medium fly ball to right-center — caught by CF, bases loaded (all runners may tag up)',
    positions: {
      P:   go('p-backup-home', 'Back up home plate', true, null, 'Sprint behind home plate in line with the throw — stops any overthrow from letting the runner advance.'),
      C:   go('cover-home', 'Set up at home', false),
      '1B':hold('1B', 'Cover 1B'),
