...
export const SITUATIONS = [
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    positions: {
      P:   go('p-backup-2b', 'Back up 2B on tag throw from LF', true, null, 'Runner tags from 1B and can only reach 2B — P backs up in case of an errant throw to 2B.'),
      C:   hold('C', 'Stay at home plate'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('cover-2b', 'Cover 2B; receive throw', false),
      SS:  go('relay-lf-to-2b', 'Move into relay between LF and 2B', true, null, 'Runner tags from 1B and heads to 2B — SS gets halfway between LF and 2B on the throw line.'),
      '3B':hold('3B', 'Hold at 3B'),
      LF:  hold('LF', 'Catch; throw to SS relay toward 2B if runner tags'),
...

  {
    ...
    positions: {
      P:   go('p-backup-2b', 'Back up 2B on tag throw from CF', true, null, 'Runner tags from 1B and can only reach 2B — P backs up in case of an errant throw to 2B.'),
      C:   hold('C', 'Stay at home plate'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('cover-2b', 'Cover 2B; receive throw', false),
      SS:  go('relay-cf-to-2b', 'Move into relay between CF and 2B', true, null, 'Runner tags from 1B and heads to 2B — SS gets halfway between CF and 2B on the throw line.'),
      '3B':hold('3B', 'Hold at 3B'),
      ...
      CF:  hold('CF', 'Catch; throw to SS relay toward 2B if runner tags'),
...

  {
    ...
    positions: {
      P:   go('p-backup-2b', 'Back up 2B on tag throw from RF', true, null, 'Runner tags from 1B and can only reach 2B — P backs up in case of an errant throw to 2B.'),
      C:   hold('C', 'Stay at home plate'),
      '1B':hold('1B', 'Cover 1B'),
      '2B':go('relay-rf-to-2b', 'Move out as relay between RF and 2B', true, null, 'Runner tags from 1B and heads to 2B — 2B gets halfway between RF and 2B on the throw line.'),
      SS:  go('cover-2b', 'Cover 2B; receive throw', true, null, 'SS covers the bag while 2B goes out for the relay — ready to apply the tag on the tagging runner.'),
      '3B':hold('3B', 'Hold at 3B'),
      ...
      RF:  hold('RF', 'Catch; throw to 2B relay toward bag if runner tags'),
    },
  },
